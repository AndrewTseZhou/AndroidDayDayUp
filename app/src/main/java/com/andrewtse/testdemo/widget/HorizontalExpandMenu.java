package com.andrewtse.testdemo.widget;
...
public class HorizontalExpandMenu extends RelativeLayout {
    ...
    private void init() {
        ...
        menuBackColor = typedArray.getColor(R.styleable.HorizontalExpandMenu_hem_back_color, Color.WHITE);
        menuStrokeSize = typedArray.getDimension(R.styleable.HorizontalExpandMenu_hem_stroke_size, 1);
        menuStrokeColor = typedArray.getColor(R.styleable.HorizontalExpandMenu_hem_stroke_color, Color.GRAY);
        menuCornerRadius = typedArray.getDimension(R.styleable.HorizontalExpandMenu_hem_corner_radius, dip2px(mContext, 20));

        buttonStyle = typedArray.getInteger(R.styleable.HorizontalExpandMenu_hem_button_style, Right);
        buttonIconDegrees = 90;
        buttonIconSize = typedArray.getDimension(R.styleable.HorizontalExpandMenu_hem_button_icon_size, dip2px(mContext, 8));
        buttonIconStrokeWidth = typedArray.getDimension(R.styleable.HorizontalExpandMenu_hem_button_icon_stroke_width, 8);
        buttonIconColor = typedArray.getColor(R.styleable.HorizontalExpandMenu_hem_button_icon_color, Color.GRAY);

        expandAnimTime = typedArray.getInteger(R.styleable.HorizontalExpandMenu_hem_expand_time, 400);
        typedArray.recycle();
