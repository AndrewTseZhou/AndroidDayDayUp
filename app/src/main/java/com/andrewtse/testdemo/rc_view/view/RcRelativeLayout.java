...
public class RcRelativeLayout extends RelativeLayout implements Checkable, RcAttrs {
    ...
    public void setBottomRightRadius(float bottomRightRadius) {
        mRcHelper.radiusInfo[4] = bottomRightRadius;
        mRcHelper.radiusInfo[5] = bottomRightRadius;
        invalidate();
    }

    @Override
    public void setBottomLeftRadius(float bottomLeftRadius) {
        mRcHelper.radiusInfo[6] = bottomLeftRadius;
        mRcHelper.radiusInfo[7] = bottomLeftRadius;
        invalidate();
    }
