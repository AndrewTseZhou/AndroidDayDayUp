 ...
 * @date 2019/3/23
 */
public class DatePickerDialog extends Dialog implements DatePickerView.OnSelectListener, View.OnClickListener {
    private static final String TAG = DatePickerDialog.class.getSimpleName();
    private static final int SPACE = 5;

    private Context mContext;

    private DatePickerView mpvDialogDay;
    private DatePickerView mpvDialogYear;
    private DatePickerView mpvDialogMonth;
    private DatePickerView mpvDialogHour;
    private DatePickerView mpvDialogMinute;
    ...
    private static float getScreenWidth(Activity context) {
    ...
    public static class Builder {
        ...
        private void applyConfig(DatePickerDialog dialog) {
            if (this.mGravity == 0) {
