...
public class DatePickerView extends View {
    ...
    static class MHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            DatePickerView mPickerView = (DatePickerView) mWeakReference.get();
            if (mPickerView != null) {
                if (Math.abs(mPickerView.mMoveDistance) < SPEED) {
                    ...
                    mPickerView.mMoveDistance = mPickerView.mMoveDistance - mPickerView.mMoveDistance / Math.abs(mPickerView.mMoveDistance) * SPEED;
                }
