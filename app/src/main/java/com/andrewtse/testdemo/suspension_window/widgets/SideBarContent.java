package com.andrewtse.testdemo.suspension_window.widgets;
...
import com.andrewtse.testdemo.suspension_window.SideBarService;
...
public class SideBarContent implements View.OnClickListener {
    ...
    LinearLayout getView(Context context, boolean left, WindowManager windowManager, WindowManager.LayoutParams params, LinearLayout arrowView, SideBarService sideBarService, LinearLayout anotherArrowView) {
        mContext = context;
        mLeft = left;
